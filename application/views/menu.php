        <ul id="sidebarnav" class="in">
                    ...
                    <li class="sidebar_nav" id="operatormenu">
                        <a  onclick="page('5')" href="#" style="color : white"><i style="color:white;" class="fa fa fa-address-book" style="color:white;"></i>
  ...
  <div id="menu" class="collapse" style="background-color:#1c2128; list-style:none; padding-left:40px; ">
                    ...
                    <li class="sidebar_nav sidebarnew" style="padding:10px;">
                        ...
                        <span class="hide-menu">Laporan Pembelian Barang</span>
                        </a>
                    </li>
                    <li class="sidebar_nav sidebarnew" style="padding:10px;">
