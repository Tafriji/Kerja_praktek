<div class="row">
                    ...
                    <h3 align="center" class="page-header">
                           TOKO LINTANG<br>Data Pembelian
                        </h3>
                    </div>
                </div> 
                <!-- /. ROW  -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        foreach ($record->result() as $r) { ?>
                                            <tr class="gradeU">
                                                ...
                                                <td>Rp. <input name="harga" value="<?php echo number_format($r->harga,2)?>" hidden readonly><?php echo number_format($r->harga,2)?></td>
                                                ...
                                                <td><input id="<?php echo $r->id_barang ?>jumlah" type="number" name="jumlah" value='1' min='1' ><td>
                                                    ...
                                                    <select id="<?php echo $r->id_barang ?>supliyer" name="id_supliyer" class="form-control" style="margin-bottom: 15px;">
                                                    <?php foreach ($record3->result() as $k) {
                                                        echo "<option value='$k->id_supliyer'";
                                                        echo">$k->nama</option>";
                                                    } ?>
                                                </select>
                                                <td>
...
<script >
 ...
 { 
    ...
    var id_supliyer =  $('#'+id+'supliyer').val();
        $.ajax({
